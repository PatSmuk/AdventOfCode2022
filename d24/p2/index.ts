...
const path1 = findPathThroughBlizzards(startX, startY, endX, endY, 0)
const path2 = findPathThroughBlizzards(endX, endY, startX, startY, path1.length)
const path3 = findPathThroughBlizzards(startX, startY, endX, endY, path1.length + path2.length)

console.log(path1.length + path2.length + path3.length)
